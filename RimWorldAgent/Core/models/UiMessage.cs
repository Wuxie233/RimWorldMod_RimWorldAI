...
namespace RimWorldAgent.Core
{
    ...
    public abstract class UiMessage
    {
        ...
        public static UiSystemInit SystemInit(string? model, string? sessionId, string? claudeCodeVersion = null,
            string? cwd = null, string? permissionMode = null, string? apiKeySource = null, List<UiMcpServerRef>? mcpServers = null,
            List<string>? tools = null, List<string>? skills = null)
            => new UiSystemInit(model, sessionId, claudeCodeVersion, cwd, permissionMode, apiKeySource,
    ...
    public class UiSystemInit : UiMessage
    {
        ...
        public UiSystemInit(string? model, string? sessionId, string? claudeCodeVersion, string? cwd,
            string? permissionMode, string? apiKeySource, List<UiMcpServerRef> mcpServers, List<string> tools, List<string> skills)
        { this.model = model; this.session_id = sessionId; this.claude_code_version = claudeCodeVersion;
          this.cwd = cwd; this.permissionMode = permissionMode; this.apiKeySource = apiKeySource;
