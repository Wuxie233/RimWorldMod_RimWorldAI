...
namespace RimWorldMCP.Tools
{
    public class Tool_GetTileDetail : ITool
    {
        ...
        public JsonElement InputSchema => JsonSerializer.SerializeToElement(new
        {
            ...
            properties = new
            {
                min_x = new { type = "integer", description = "X 范围最小值" },
                min_y = new { type = "integer", description = "Y 范围最小值" },
                max_x = new { type = "integer", description = "X 范围最大值" },
                max_y = new { type = "integer", description = "Y 范围最大值" }
            },
